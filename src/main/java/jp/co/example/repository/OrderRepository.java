...
public class OrderRepository {
	...
	/**
	 * 引数で受け取ったユーザーId、ステータス情報をもとに注文情報を検索します. 引数で受け取ったステータス以外ステータスをもつ注文情報を検索します。
	 * 
	 * @param userId ユーザーId
	 * @param status ステータス
	 * @return 注文情報
	 */
	public List<Order> findByUserIdAndStatusNotZero(Integer userId, Integer status) {
		StringBuilder sql = new StringBuilder();
		sql.append(
				"SELECT o.id o_id,o.user_id o_user_id,o.status o_status,o.total_price o_total_price,o.order_date o_order_date,");
		sql.append(
